...
_See code: [src/commands/add-default-values.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/add-default-values.js)_
...
_See code: [src/commands/add-field-to-every-phase.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/add-field-to-every-phase.js)_
...
_See code: [src/commands/add-field-to-every-pipe.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/add-field-to-every-pipe.js)_
...
_See code: [src/commands/edit-email-templates.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/edit-email-templates.js)_
...
_See code: [src/commands/fix-duplicate-field-values.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/fix-duplicate-field-values.js)_
...
_See code: [src/commands/generate-docs.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/generate-docs.js)_
...
_See code: [src/commands/hello.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/hello.js)_
...
_See code: [src/commands/remove-duplicate-db-entries.js](https://github.com/GenieTim/PipefyEnhancer/blob/v1.4.1/src/commands/remove-duplicate-db-entries.js)_
<!-- commandsstop -->
